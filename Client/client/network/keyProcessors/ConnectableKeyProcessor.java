...
import network.ConnectTask;
import network.ConnectionListener;
import network.ReadWriteAttachment;
import network.TimeoutStorage;
...
public class ConnectableKeyProcessor implements KeyProcessor {
  ...
  private static final Logger logger = TorrentLoggerFactory.getLogger(null);
