...
import client.PeerInformation;
import client.Piece;
import client.SharedTorrent;
...
import network.WriteListener;
import network.WriteTask;
...
public class SharingPeer extends Peer implements MessageListener, PeerInformation {
  ...
  public void cancelPendingRequests( final Piece piece) {
    synchronized (this.requestsLock) {
      if (piece != null) {
        myRequestedPieces.remove(piece);
      } else {
