...
public class HTTPAnnounceResponseMessage extends HTTPTrackerMessage
  ...
  public static HTTPAnnounceResponseMessage parse(BEValue decoded)
    ...
    try {
      ...
      return new HTTPAnnounceResponseMessage(Constants.EMPTY_BUFFER, infoHash,
  ...
  public static HTTPAnnounceResponseMessage craft(byte[] infoHash,
...
public static HTTPAnnounceResponseMessage craft(int i, int seeders, int leechers, Object object, String hexInfoHash) {
